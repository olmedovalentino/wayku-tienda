                ...
                <div className="hidden lg:grid lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4">
                    {filteredProducts.map((product) => {
                        ...
                        return (
                            <article
                                key={product.id}
                                className="overflow-hidden rounded-[24px] border border-stone-200 bg-[linear-gradient(180deg,#ffffff_0%,#fbf8f3_100%)] shadow-[0_16px_38px_-30px_rgba(120,92,54,0.42)] transition-all hover:-translate-y-0.5 hover:shadow-[0_24px_52px_-30px_rgba(120,92,54,0.5)]"
                            >
                                ...
                                <div className="space-y-4 p-4">
                                    <div className="flex items-start justify-between gap-3">
                                        <div className="min-w-0">
                                            <h3 className="truncate text-base font-semibold text-stone-900">{product.name}</h3>
                                            <p className="mt-1 line-clamp-2 text-xs text-stone-500">{product.description}</p>
                                        </div>
                                        <div className="rounded-xl bg-stone-900 px-2.5 py-2 text-right text-white shadow-sm">
                                    ...
                                    <div className="grid grid-cols-3 gap-2">
                                        <div className="rounded-xl border border-stone-100 bg-white p-2.5">
                                            ...
                                            <p className="mt-1.5 text-base font-semibold text-stone-900">{stockValue}</p>
                                        ...
                                        <div className="rounded-xl border border-stone-100 bg-white p-2.5">
                                            ...
                                            <p className="mt-1.5 text-xs font-semibold text-stone-900">{getMaterialLabel(product.material)}</p>
                                        </div>
                                        <div className="rounded-xl border border-stone-100 bg-white p-2.5">
                                            <p className="text-[11px] uppercase tracking-[0.18em] text-stone-400">Imagenes</p>
                                            <p className="mt-1.5 text-base font-semibold text-stone-900">{product.images.length}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-2 border-t border-stone-100 pt-3">
                                        <Button
                                            variant="outline"
                                            className="flex-1 rounded-xl border-stone-200 bg-white px-3 py-2.5 text-sm"
                                        ...
                                        <Button
                                            variant="outline"
                                            className="rounded-xl border-red-100 bg-red-50 px-3 py-2.5 text-red-600 hover:bg-red-100 hover:text-red-700"
