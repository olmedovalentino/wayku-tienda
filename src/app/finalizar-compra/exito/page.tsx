    ...
    return (
        <div className="flex min-h-[80vh] flex-col items-center justify-center px-4 py-12 text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-stone-600 max-w-md mx-auto mb-8">
                {method === 'transfer'
                    ? `Hola ${name}, hemos registrado tu pedido. Para finalizar el proceso, por favor segui las instrucciones de pago.`
                    : 'Tu pedido ha sido procesado con exito. Pronto recibiras un correo electronico con los detalles de tu compra.'}
            </p>
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-stone-100 shadow-sm space-y-5">
                            <div className="flex items-center justify-between group">
                                ...
                                <Button
                                    variant="outline"
                                    size="sm"
                                    className="h-8 px-4 rounded-xl border-stone-200 hover:border-primary hover:text-primary transition-all"
                                    onClick={() => {
                                        navigator.clipboard.writeText('waykuargentina');
                                        alert('Alias copiado');
                                    }}
                                >
                                    Copiar
                            ...
                            <div className="flex items-center justify-between group">
                                ...
                                <Button
                                    ...
                                    className="h-8 px-4 rounded-xl border-stone-200 hover:border-primary hover:text-primary transition-all"
                                    onClick={() => {
                                        navigator.clipboard.writeText('0000003100043743912911');
                                        alert('CVU copiado');
                                    }}
                                >
                                    Copiar
                    ...
                    <div className="bg-green-50 border border-green-100 rounded-2xl p-5 flex gap-4 items-start">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-green-700 leading-relaxed mb-1">
                                Para que despachemos tu lampara, envia el comprobante por WhatsApp al <strong className="text-green-900">3513844333</strong>.
                            </p>
                        </div>
                    </div>
                </div>
